...
--
-- Host: 127.0.0.1
-- Generation Time: 16-Fev-2016 às 23:21
...
(18, 'A1.2 Na Graduação', NULL, NULL, 2),
(19, 'A1.1 Na Pós-Graduação', NULL, NULL, 2),
(20, 'A1.4 Coordenação de projetos de ensino, eixos de componentes curriculares, preceptores de residência ou similares', NULL, NULL, 2),
(21, 'A1.3 Coordenação institucional em programas acadêmicos (CsF, PIBID, PET), por programa', NULL, NULL, 2),
...
--
ALTER TABLE `tb_progressao`
  MODIFY `id_progressao` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=75;
--
